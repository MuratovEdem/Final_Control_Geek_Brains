...
public class Animals {
    ...
    public Animals(String name, String dateBirth) {
        this.name = name;
...
class Pets extends Animals {
    ...
    public Pets(String name, String dateBirth, String command) {
...
class PackAnimals extends Animals {
    ...
    public PackAnimals(String name, String dateBirth, String command) {
        super(name, dateBirth);
        this.command = command;
    }
...
class Dog extends Pets {
    public Dog(String name, String dateBirth, String command) {
        super(name, dateBirth, command);
    }
}

class Cat extends Pets {
    public Cat(String name, String dateBirth, String command) {
        super(name, dateBirth, command);
    }
}

class Hamster extends Pets {
    public Hamster(String name, String dateBirth, String command) {
        super(name, dateBirth, command);
    }
}

class Horse extends PackAnimals {
    public Horse(String name, String dateBirth, String command) {
        super(name, dateBirth, command);
    }
}

class Camel extends PackAnimals {
    public Camel(String name, String dateBirth, String command) {
        super(name, dateBirth, command);
    }
}

class Donkey extends PackAnimals {
    public Donkey(String name, String dateBirth, String command) {
        super(name, dateBirth, command);
    }
}
~~~
